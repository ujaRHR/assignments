                    ...
                    <form action="/search" method="GET">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label for="departureDate" class="fw-bold">Departure Date:</label>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <label for="routeSelection" class="fw-bold">Select Route</label>
                                        <select class="form-control" id="routeSelection" name="routeSelection" required>
