...
<head>
  ...
  <title>Sell Products - StoreKeeper</title>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Sell Products</h1>
            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="productName" class="form-label fw-bold">Choose the Product</label>
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="productPrice" class="form-label fw-bold">Price (BDT)</label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <input type="number" step="1" class="form-control" id="productQuantity" name="productQuantity" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label for="totalPrice" class="form-label fw-bold">Total Price (BDT)</label>
